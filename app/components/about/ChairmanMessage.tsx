        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-1">
              <div className="bg-gradient-to-br from-amber-100 to-orange-100 h-64 rounded-2xl flex items-center justify-center text-8xl relative shadow-lg">
                <span>👨‍🍳</span>
              </div>
              <p className="text-center mt-4 font-semibold text-gray-800 text-xl">
