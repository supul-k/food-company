      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-gray-600">
            Sustenance Lanka products are naturally rich in protein, vitamins, and minerals. From strong bones to healthy digestion and lasting energy, every product is crafted to nourish your body.
          </p>
        </div>
